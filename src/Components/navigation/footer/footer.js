    ...
    return (
        <footer id="footer" className="footer">
            <Container>
                ...
                <Row>
                    <Col>
                        <p className="footer-text">Contact: 7230070491<br />Order: 9670300800, 9670400900, 9670800100 <br />
                            &copy; COPYRIGHT 2018 reserved by 2 Brother Pizza and Burger<br /><br/>
                            Made with <img src={} alt="Heart" style={{ height: "22px", padding: "0 3px", float: "none" }} /> from <a style={{ display: "inline", float: "none" }} href="https://willis-digital.netlify.app/">Pramay Jain</a></p>
                    </Col>
                </Row>
            </Container>
        </footer>
